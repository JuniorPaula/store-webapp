...
// WsEndPoint is a handler which renders a page where the user can enter their payment details.
type Invoice struct {
	ID        int       `json:"id"`
...
func (app *application) PaymentSucceeded(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		app.errorLog.Println("[ERROR] to call invoice microservice:", err.Error())
	}
...
func (app *application) callInvoiceMicroservice(invoice Invoice) error {
	...
	app.infoLog.Println("response Status:", resp.Status)
